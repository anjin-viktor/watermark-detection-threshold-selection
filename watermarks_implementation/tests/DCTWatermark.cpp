...
BOOST_AUTO_TEST_CASE(dct_watermark)
{
  ...
  DCTWatermark watermark(0.3, 0.1, skipCount, reference);
...
BOOST_AUTO_TEST_CASE(dct_watermark_crop)
{
  ...
  DCTWatermark watermarkCropped(0.3, 0.1, skipCount, referenceCropped);
  ...
  DCTWatermark watermarkCroppedFalse(0.3, 0.1, skipCount, referenceCropped);
